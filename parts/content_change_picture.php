                    ...
                    <div class="row layout-spacing">
						...
						<?php if(isset($message)) echo $message; ?>
                          ...
                          <form action="" method="post" enctype="multipart/form-data">
                                <div class="info">                                
                                    <h6 class="mt-4 title">Change Picture</h6>
									<p>To change it, select your photo and update. (The photo must be 300x300 in dimension and must be less than 200Kb in size and file extension must be JPG.)</p>
							
                                    <div class="row">
                                        <div class="col-lg-12 col-md-5">
                                            <div class="upload ml-md-5 mt-4 pr-md-4">
                                               
											   <input type="file" name="picture" class="dropify" data-default-file="<?php echo APP_URL.$user_info['picture']; ?>" data-max-file-size="2M" />
